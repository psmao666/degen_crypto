...
namespace degen_crypto { namespace kitchen { class StrategyManager; }}

namespace degen_crypto { namespace exchange { namespace bybit {

class BybitExchange : public ExchangeEngine<BybitExchange> {

friend class ExchangeEngine<BybitExchange>;
